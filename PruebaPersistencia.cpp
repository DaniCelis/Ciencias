...
//			}while(opc>5 || opc<1);	
		...
		case 4:{
			...
			string nombre = "Danilea";
			string apellido="Celis";
			cout<<"Que persona quiere editar ingrese el id"<<endl;
			
			string datos="";
			ingid<<":"<<ingnombre<<":"<<ingapellido<<":"<<settipoid<<":"<<ingdocumento<<":"<<aggenero<<":"<<ingfijo<<":"<<ingcelular<<":"<<ingemail<<":"<<ingfechaNac<<":"<<ingedad<<":"
				<<ingciudadNac<<":"<<ingpaisNac<<":"<<ingciudadRes<<":"<<ingdireccion<<":"<<ingbarrio<<":"<<ingactividad<<":"<<inghijos<<":"<<ingnumhijos<<":"<<agsucursal<<endl;
			cout<<datos<<endl;
		//	editar();
			break;
